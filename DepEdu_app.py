...
def DepEdu_app():
    ...
    dep_edu_column_index = dep_edu_df.columns.get_loc(numeric_columns)
    ...
    if dep_edu_column in numeric_columns:
        ...
        dep_edu_search_term = st.text_input(f'{dep_edu_column}에서 검색할 내용 입력', key='QWGJK_new_search_term')
